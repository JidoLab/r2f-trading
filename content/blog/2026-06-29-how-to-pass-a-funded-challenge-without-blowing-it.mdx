export const metadata = {
  ...
  date: "2026-06-29",
  excerpt: "Most traders fail funded challenges for a reason that has little to do with strategy. They trade the challenge differently than they trade in real life. Here's the exact process that separates passers from chronic resetters.",
