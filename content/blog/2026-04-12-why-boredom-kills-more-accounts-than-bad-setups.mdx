export const metadata = {
  ...
  seoDescription: "Discover why boredom trading destroys more accounts than bad setups. Learn from 10+ years ICT trading experience how to overcome the hidden account killer most traders ignore.",
