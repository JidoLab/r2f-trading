export const metadata = {
  ...
  seoDescription: "Learn how smart money concepts explain the fake-out moves around Retail Sales data releases. Harvest Wright breaks down ICT liquidity grabs, displacement, and how to avoid chasing false spikes on USD pairs.",
