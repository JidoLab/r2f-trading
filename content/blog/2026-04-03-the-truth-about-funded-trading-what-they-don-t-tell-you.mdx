export const metadata = {
  ...
  seoDescription: "Funded trading hides costly fine print most traders ignore—payout rules, drawdown traps, and ICT strategy limits that kill accounts before profits start.",
