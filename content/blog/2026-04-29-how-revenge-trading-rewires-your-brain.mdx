export const metadata = {
  ...
  seoTitle: "Revenge Trading Isn't a Discipline Problem (Brain Science)",
  date: "2026-04-29",
  ...
  seoDescription: "Neuroscience proves revenge trading is a threat-survival reflex, not weak willpower. Why ICT precision makes you uniquely vulnerable, and the 90-second loop-break.",
