export const metadata = {
  ...
  seoDescription: "Stop falling for smart money's psychological traps. These 5 mind games exploit retail trader bias daily — recognize them and start trading with an edge.",
