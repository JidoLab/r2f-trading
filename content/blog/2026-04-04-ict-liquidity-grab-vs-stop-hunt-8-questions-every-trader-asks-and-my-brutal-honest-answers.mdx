export const metadata = {
  title: "Liquidity Grab vs Stop Hunt: 8 Key Questions",
...
> **Key Takeaway:** Misidentifying stop hunts as liquidity grabs—or vice versa—leads directly to wrong entries and blown accounts, so mastering the precise distinction between these two institutional moves is the foundational skill every ICT trader must develop before sizing up positions.
