export const metadata = {
  ...
  seoDescription: "Confused about liquidity grabs vs stop hunts? An ICT mentor with 10+ years answers 8 critical questions to help you stop misreading price action.",
