export const metadata = {
  ...
  seoDescription: "Spot institutional liquidity raids during earnings season using 6 core ICT concepts—stop hunts, order blocks, and FVGs explained with real trade setups.",
