export const metadata = {
  ...
  seoDescription: "Stay mentally sharp before CPI releases with proven trading psychology tactics that separate disciplined traders from those who blow up on inflation data.",
