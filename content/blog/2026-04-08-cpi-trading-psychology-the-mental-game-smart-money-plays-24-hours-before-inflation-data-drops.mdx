export const metadata = {
  title: "CPI Trading Psychology: The Pre-Data Mental Game",
...
> **Key Takeaway:** Managing your psychology *before* a CPI release — not during it — is what separates consistent traders from blown accounts; establish your bias, define your invalidation levels, and commit to your plan hours before the data drops so emotion has nothing left to hijack.
