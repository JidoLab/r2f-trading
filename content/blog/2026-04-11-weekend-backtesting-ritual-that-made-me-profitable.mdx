export const metadata = {
  ...
  seoDescription: "Discover the weekend backtesting ritual that transformed my ICT trading results from losing to profitable. Learn the exact steps, tools, and mindset shifts.",
