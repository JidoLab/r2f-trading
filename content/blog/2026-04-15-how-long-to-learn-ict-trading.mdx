export const metadata = {
  ...
  seoDescription: "Learn how long it realistically takes to learn ICT trading from scratch. Mentor Harvest Wright shares honest timelines, key milestones, and the fastest path to consistency.",
