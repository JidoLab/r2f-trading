export const metadata = {
  ...
  seoDescription: "Learn how I successfully passed the FTMO challenge in 12 days with ICT trading strategies. Day-by-day breakdown of entries, exits, and risk management.",
