export const metadata = {
  ...
  seoDescription: "Discover the key differences between ICT mitigation blocks and order blocks. Learn identification techniques, entry/exit rules, and which provides better risk-reward ratios.",
