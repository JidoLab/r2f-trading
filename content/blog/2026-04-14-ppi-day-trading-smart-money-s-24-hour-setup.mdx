export const metadata = {
  ...
  seoDescription: "Get ahead of PPI releases using institutional order blocks, fair value gaps, and smart money manipulation tactics that define the 24-hour trading setup.",
