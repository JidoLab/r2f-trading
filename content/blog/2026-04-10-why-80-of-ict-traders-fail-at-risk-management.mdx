export const metadata = {
  ...
  seoDescription: "Discover why 80% of ICT traders fail at risk management despite high win rates. Learn the deadly myths about position sizing, correlation risk, and setup confidence that blow accounts.",
