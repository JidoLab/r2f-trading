export const metadata = {
  ...
  seoDescription: "Tired of missing entries by minutes? ICT killzones outperform session opens for precision timing — see the real data before your next trade.",
