      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-[9px] font-bold tracking-[0.3em] uppercase text-white/70 ml-0.5 mt-1">
              Trading
            </span>
          </div>
          ...
          <div className="flex items-center gap-4">
            {/* Instagram */}
            <a
              href="https://instagram.com/road2funded"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
              className="w-10 h-10 rounded-full bg-white/10 hover:bg-gold/30 flex items-center justify-center text-white/80 hover:text-gold transition-all"
            >
            ...
            {/* X / Twitter */}
            <a
              href="https://twitter.com/Road2Funded"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="X"
              className="w-10 h-10 rounded-full bg-white/10 hover:bg-gold/30 flex items-center justify-center text-white/80 hover:text-gold transition-all"
            ...
            {/* TradingView */}
            <a
              href="https://www.tradingview.com/u/Road_2_Funded"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M5.5 3H2v18h3.5V3zm6.5 6H8.5v12H12V9zm6.5-3H15v15h3.5V6z" />
              </svg>
            </a>
