...
const POST_TYPES = [
  ...
  { id: "promo-free-class", prompt: "Promote the free ICT Funded-Trader Playbook in an exciting, non-spammy way. Mention what's inside (the 3 setups that actually work, the pre-trade checklist, risk rules that pass funded challenges). Include the link: https://r2ftrading.com/free-class. NEVER mention students, mentees, or coaching clients. No em dashes. Example: 'The free ICT Funded-Trader Playbook: the 3 setups that actually work, the pre-trade checklist, and the risk rules that keep funded accounts alive. Instant download 👇 https://r2ftrading.com/free-class'" },
  ...
  { id: "promo-checklist", prompt: "Promote the free ICT Funded-Trader Playbook from the discipline angle. Mention the pre-trade checklist inside it. Include: https://r2ftrading.com/free-class. NEVER mention students, mentees, or coaching clients. No em dashes. Example: 'I run the same pre-trade checklist before every single trade. It's inside the free ICT Funded-Trader Playbook, along with the risk rules that keep funded accounts alive. Grab it free 👇 https://r2ftrading.com/free-class'" },
