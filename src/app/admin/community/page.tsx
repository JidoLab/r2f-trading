    ...
    <div className="max-w-4xl space-y-8">
      ...
      <div className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {[
            { label: "Free Playbook Promo", text: "📘 *Free ICT Funded-Trader Playbook*\n\nThe 3 setups that actually work, the pre-trade checklist, and the risk rules that pass funded challenges.\n\n👉 r2ftrading.com/free-class\n\nInstant download. Start today!" },
