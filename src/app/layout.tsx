      ...
      <head>
        ...
        {process.env.NEXT_PUBLIC_FB_PIXEL_ID && (
          <>
            ...
            <noscript>
              {/* eslint-disable-next-line @next/next/no-img-element -- 1x1 Facebook tracking pixel (a beacon, not an image). next/image would wrap and try to optimize it, breaking the noscript fallback. */}
